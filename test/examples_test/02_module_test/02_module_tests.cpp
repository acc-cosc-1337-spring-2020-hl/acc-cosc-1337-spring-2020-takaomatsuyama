...
TEST_CASE("Test get generation function")
	...
	REQUIRE(get_genaration(1997) == "Centenial");
	REQUIRE(get_genaration(1995) == "Millenial");
	REQUIRE(get_genaration(1970) == "Generation X");
	REQUIRE(get_genaration(1950) == "Baby Boomer");
	REQUIRE(get_genaration(1930) == "Silent Generation");
}
